...
% Last Modified by GUIDE v2.5 01-Feb-2015 11:04:56
...
y = get(handles.edit2,'String'); 
 if isempty(x)||isempty(y)
  uiwait(warndlg('Error: Enter some Text into password or username field')); 
 else
     match1 = strcmp(x,'projectX');
     match2 = strcmp(y,'secret');
     
        if match1 == 1 && match2 == 1   
        close all force;
        page2
        else
        uiwait(warndlg('Error:Invalid Details')); 
        end
 end        